...
def ozel_tablo_html_olustur_gunluk(df, url_map):
    ...
    @media screen and (max-width: 768px) {{
        ...
        .mc-body {{ padding-top: 5px; font-size: 13px; color: #333; line-height: 1.5; }}
        .gorsel-buton {{ float: none; width: 100%; justify-content: center; padding: 12px; font-size: 14px; margin-top: 12px; border-radius: 6px; }}
    }}
    </style>
    </head>
    <body>
    ...
    <div class='desktop-view'><div class='tablo-sarmalayici'><table class='ozel-tablo'>
    <thead><tr>
    """
    ...
    function closeModal() { document.getElementById('imgModal').style.display = 'none'; document.getElementById('modalIframe').src = ''; }
    </script>
    </body></html>
    """
    return html
...
def ozel_tablo_html_olustur_acil(df, url_map):
    ...
    @media screen and (max-width: 768px) {{
        ...
        .ozel-tablo td {{ display: block; padding: 10px 15px; border: none; border-bottom: 1px solid #f0f0f0; font-size: 14px; position: relative; text-align: right; padding-left: 45%; }}
        ...
        .sira-sutunu {{ width: auto; text-align: right; background-color: {renk_tema} !important; color: #fff !important; font-size: 16px; padding: 12px 15px !important; }}
